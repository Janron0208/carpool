...
class UsingCheckInMobile extends StatefulWidget {
  const UsingCheckInMobile({super.key});

  @override
  State<UsingCheckInMobile> createState() => _UsingCheckInMobileState();
}

class _UsingCheckInMobileState extends State<UsingCheckInMobile> {
  String? loaddata = 'yes';
  String? loadPic = 'no';
  String? accID;
