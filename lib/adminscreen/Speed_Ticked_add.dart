...
class Speedticked_Add extends StatefulWidget {
  const Speedticked_Add({super.key});

  @override
  State<Speedticked_Add> createState() => _Speedticked_AddState();
}

class _Speedticked_AddState extends State<Speedticked_Add> {
  String? loaddata = 'no';
